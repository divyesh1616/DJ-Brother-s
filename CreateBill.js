...
const CreateBill = () => {
  ...
  const [Product, Set_Product] = useState("Dell");
      ...
      <ScrollView>
        ...
        <View style={styles.InputContainer}>
          ...
          >
            ...
            <Picker.Item label="Mackbook" value="Mackbook" />
            <Picker.Item label="Mackbook-pro" value="Mackbook-pro" />
            <Picker.Item label="Acer" value="Acer" />
            <Picker.Item label="Lenovo" value="Lenovo" />
            <Picker.Item label="Lenovo-ThinkPad" value="Lenovo-ThinkPad" />
