...
<html>
  ...
  <body >
    ...
    <div class="data-title">
        ...
        font-size: 2rem;  
        padding-left: 20px;">JV Tecgnologies<br></div>
    <div style="
    display: flex;
    flex-direction: column;
    align-items: flex-start; 
    padding-left: 20px;
    ">At Post Mr.Jatin Dist Ahmedabad.</div>
    </div>
    ...
    <hr />
        ...
        <div style="height:auto; padding: 20px;">
            ...
            Bank Name: SBI Bank, Khokhra<br/>
            Bank Account no :100424646<br/>
            Bank IFSC code : SBINO00987<br/>
            </p>
